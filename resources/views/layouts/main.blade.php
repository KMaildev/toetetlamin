...
<head>
    ...
    <title>
        TOE TET LA MIN CO.,LTD （Overseas Employment Agency） - @yield('title')
    </title>
    <meta name="keywords" content="TOE TET LA MIN CO.,LTD" />
    <meta name="author" content="TOE TET LA MIN CO.,LTD" />
    <meta name="robots" content="TOE TET LA MIN CO.,LTD" />
    <meta name="description" content="TOE TET LA MIN CO.,LTD" />
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img
                        src="{{ asset('assets/images/resources/logo-2.png') }}" width="135" alt="" /></a>
            </div>
            <!-- /.logo-box -->
